							...
							<div class = "tab1"  style="height:60%; border:solid 1px; float:top">								
								...
								<div id="myTabContent" class="tab-content">
										...
										<div style="background-color:transparent;float:top;">
											<table style="background-color:transparent;">				
												...
												<tr >
													...
													<button id="CaseInqueryBotton" style= "height:25px;width:65px" >查询</button>									
													</td>					
												</tr>
											</table>
										</div>
									...
									<div class="tab-pane fade" id="material">
										<p>
										<script type="text/javascript">
											String v = document.getElementById('e-correlation').value;
										</script>
										<textarea id = "material_show_all" rows="10" cols="40">此处显示</textarea>										
										</p>
									</div>
